...
final class L10n {
    ...
    private static let tables: [AppLanguage: [String: String]] = [
        .en: [
            ...
            "settings.languageNote": "Stories and city culture are in English while translations are being chronicled.",
        ...
        .es: [
            ...
            "settings.languageNote": "Las historias y la cultura urbana están en inglés mientras se traducen.",
        ...
        .fr: [
            ...
            "settings.languageNote": "Les histoires et la culture des villes restent en anglais pendant leur traduction.",
        ...
        .de: [
            ...
            "settings.languageNote": "Geschichten und Stadtkultur bleiben auf Englisch, während sie übersetzt werden.",
        ...
        .it: [
            ...
            "settings.languageNote": "Storie e cultura delle città restano in inglese durante la traduzione.",
        ...
        .pt: [
            ...
            "settings.languageNote": "Histórias e cultura das cidades seguem em inglês enquanto são traduzidas.",
        ...
        .ja: [
            ...
            "settings.languageNote": "物語と都市カルチャーは翻訳が完了するまで英語で表示されます。",
        ...
        .ko: [
            ...
            "settings.languageNote": "이야기와 도시 문화는 번역이 끝날 때까지 영어로 표시됩니다.",
        ...
        .zh: [
            ...
            "settings.languageNote": "故事与城市文化内容在翻译完成前暂以英文显示。",
