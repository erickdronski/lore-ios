...
final class L10n {
    ...
    private static let tables: [AppLanguage: [String: String]] = [
        .en: [
            ...
            "scan.acquiring": "Getting your bearings… aim at a real place near you",
            "scan.stepOutside": "Can't find you here — try stepping outside",
            "scan.recognizing": "Reading what's in front of you…",
            "scan.foundNearby": "Found %d around you",
            "scan.nothingHere": "Nothing Lore knows right here",
            "scan.pointAtLandmark": "Point at a real landmark near you — Lore reads the places around you, not photos",
